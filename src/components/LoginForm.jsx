      ...
      <div className="col-md-6 col-xs-12 right-login">
        ...
        <form onSubmit={submitDetails} autoComplete="off">
          ...
          <div className="social-media-icons">
            <span className="facebook" onClick={() => openLink(`${baseUrl}/auth/social_fb`)} />
            <span className="google" onClick={() => openLink(`${baseUrl}/auth/social_ggl`)} />
            <span className="twitter" onClick={() => openLink(`${baseUrl}/auth/social_tw`)} />
          </div>
        </form>
      </div>
    </div>
