  ...
  <div className="container-fluid">
    <div className="row">
        ...
        <div className="row" id="main-article">
          <div className="col-lg-5">
            ...
            <p>
              ...
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt ad facilis aliquam rem ipsam at quidem nemo fugiat iste provident. Illum, exercitationem excepturi. Doloribus, cumque deleniti quis dolores voluptate quaerat. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Culpa mi ...
      ...
      <div className="col-xl-3 col-md-6">
        <div className="row article-col" style={{ paddingBottom: '3%', height: '30%' }}>
          <div className="col-6">
        ...
        <div className="row article-col" style={{ paddingBottom: '3%', height: '30%' }}>
          ...
          <div className="col" style={{ textAlign: 'left' }}>
            <Link to="/article/233-sddee-ed" className="article-link"><h5>Benefits of pair programming...</h5></Link>
            <div style={{ padding: '3%' }}>
              <div><Link to="/profile" className="profile-link"><span>Diana Loren</span></Link></div>
              <div>10 mins read</div>
            </div>
        ...
        <div className="row article-col" style={{ paddingBottom: '3%', height: '30%' }}>
          ...
          <div className="col" style={{ textAlign: 'left' }}>
            <Link to="/article/233-sddee-ed" className="article-link">
              <h5>Dangers of pair programming...</h5>
            </Link>
            <div style={{ padding: '3%' }}>
              <div><Link to="/profile" className="profile-link"><span>Diana Loren</span></Link></div>
              <div>10 mins read</div>
      ...
      <div className="col-xl-3 col-md most-read-articles">
        <h4 style={{ textAlign: 'center' }}>Most Read Articles</h4>
